...
DROP TABLE IF EXISTS m_point_earnings;
...
(
	tmp_faceAPI_id int NOT NULL,
	tmp_face_group_id int NOT NULL,
...
ALTER TABLE face_relation
	ADD FOREIGN KEY (tmp_faceAPI_id)
	REFERENCES tmp_faceAPI (id)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
ALTER TABLE face_relation
	ADD FOREIGN KEY (tmp_face_group_id)
	REFERENCES tmp_face_group (id)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
